            ...
            <Navbar bg="light" expand="lg" sticky="top" className={styles.nav_center}>
                <Link href='https://wa.me/6282146397875?text=Hello%2C%20Trisula%20Sunrise%20Trekking'>
                    <a className='nav-link ' target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-whatsapp" viewBox="0 0 17 17">
                ...
                <Navbar.Brand className='p-2'>
                    <Link href={`/`} lang={lang}>
                        <a className='text-white'>
                            <Image src={"/images/logo/logo-2.png"} height={100} width={100} alt='Trisula Sunrise Trekking Logo Variant 2' className="d-inline-block align-top" />
                        </a>
                    </Link>
                </Navbar.Brand>
